...
print(f"big_tensor shape: {big_tensor.shape}, type: {type(big_tensor)}")
print(f"my_dtensor shape: {my_dtensor.shape}, type: {type(my_dtensor)}")
print(f"my_dtensor.to_local() shape: {my_dtensor.to_local().shape}, type: {type(my_dtensor.to_local())}")
