...
from cyclopts import Group, Parameter, validators, App
...
class VLLMWorkerConfig(BaseModel):
    ...
    model_path: Annotated[str, Parameter(group=vllm_group, help="Path to the vLLM model.")]
...
class InferenceWorkerConfig(BaseModel):
...
@app.default
def test_command(*, config: InferenceWorkerConfig):
